...
public class Flight extends AbstractComponent {
    ...
    public void saveValues(OracleDbProvider provider) throws IllegalAccessException, SQLException {
        AbstractComponent.saveTo(Flight.class, this, provider, this.getTableName());
    }

    @Override
    public String[][] getAllRows(OracleDbProvider provider) throws SQLException, IllegalAccessException {
        return AbstractComponent.getAllFrom(Flight.class, this, provider, this.getTableName());
    }
    ...
    public void deleteRowByPrimaryKey(OracleDbProvider provider) throws NoSuchFieldException, SQLException {
        AbstractComponent.deleteFrom(this.getTableName(), provider,
                new HashMap<>() {{
                    put(Flight.getIdFlightAnnotationName(), String.valueOf(idFlight));
    ...
    public void updateRow(OracleDbProvider provider) throws SQLException, IllegalAccessException, NoSuchFieldException {
        AbstractComponent.updateTo(Flight.class, this, provider, this.getTableName(),
                new HashMap<>() {{
                    put(Flight.getIdFlightAnnotationName(), String.valueOf(idFlight));
                }});
    }
