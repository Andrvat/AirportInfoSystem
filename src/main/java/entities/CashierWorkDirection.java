...
@DbTable(name = "CASHIER_WORK_DIRECTION")
public class CashierWorkDirection extends AbstractComponent {
    ...
    public CashierWorkDirection() {
        super(CashierWorkDirection.class.getAnnotation(DbTable.class).name());
    }
    ...
    public void saveValues(OracleDbProvider provider) throws IllegalAccessException, SQLException {
        AbstractComponent.saveTo(CashierWorkDirection.class, this, provider, this.getTableName());
    }

    @Override
    public String[][] getAllRows(OracleDbProvider provider) throws SQLException, IllegalAccessException {
        return AbstractComponent.getAllFrom(CashierWorkDirection.class, this, provider, this.getTableName());
    }
    ...
    public void deleteRowByPrimaryKey(OracleDbProvider provider) throws NoSuchFieldException, SQLException {
        AbstractComponent.deleteFrom(this.getTableName(), provider,
                new HashMap<>() {{
                    put(CashierWorkDirection.getIdWorkDirectionAnnotationName(), String.valueOf(idWorkDirection));
    ...
    public void updateRow(OracleDbProvider provider) throws SQLException, IllegalAccessException, NoSuchFieldException {
        AbstractComponent.updateTo(CashierWorkDirection.class, this, provider, this.getTableName(),
                new HashMap<>() {{
                    put(CashierWorkDirection.getIdWorkDirectionAnnotationName(), String.valueOf(idWorkDirection));
                }});
    }
