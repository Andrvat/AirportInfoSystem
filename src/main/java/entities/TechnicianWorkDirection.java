...
@DbTable(name = "TECHNICIAN_WORK_DIRECTION")
public class TechnicianWorkDirection extends AbstractComponent {
    ...
    public TechnicianWorkDirection() {
        super(TechnicianWorkDirection.class.getAnnotation(DbTable.class).name());
    }

    public static String getIdWorkDirectionAnnotationName() throws NoSuchFieldException {
        return TechnicianWorkDirection.class.getDeclaredField("idWorkDirection").getAnnotation(DbColumnNumber.class).name();
    }

    public static String getDirectionNameAnnotationName() throws NoSuchFieldException {
        return TechnicianWorkDirection.class.getDeclaredField("directionName").getAnnotation(DbColumnVarchar.class).name();
    }
    ...
    public void saveValues(OracleDbProvider provider) throws IllegalAccessException, SQLException {
        AbstractComponent.saveTo(TechnicianWorkDirection.class, this, provider, this.getTableName());
    }

    @Override
    public String[][] getAllRows(OracleDbProvider provider) throws SQLException, IllegalAccessException {
        return AbstractComponent.getAllFrom(TechnicianWorkDirection.class, this, provider, this.getTableName());
    }
    ...
    public void deleteRowByPrimaryKey(OracleDbProvider provider) throws NoSuchFieldException, SQLException {
        AbstractComponent.deleteFrom(this.getTableName(), provider,
                new HashMap<>() {{
                    put(TechnicianWorkDirection.getIdWorkDirectionAnnotationName(), String.valueOf(idWorkDirection));
                }});
    }

    @Override
    public void updateRow(OracleDbProvider provider) throws SQLException, IllegalAccessException, NoSuchFieldException {
        AbstractComponent.updateTo(TechnicianWorkDirection.class, this, provider, this.getTableName(),
                new HashMap<>() {{
                    put(TechnicianWorkDirection.getIdWorkDirectionAnnotationName(), String.valueOf(idWorkDirection));
                }});
    }
