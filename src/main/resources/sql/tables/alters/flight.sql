...
ALTER TABLE FLIGHT
    ADD CONSTRAINT FLIGHT_fk1 FOREIGN KEY (departure_locality_id) REFERENCES LOCALITY (locality_id);
ALTER TABLE FLIGHT
    ADD CONSTRAINT FLIGHT_fk2 FOREIGN KEY (arrival_locality_id) REFERENCES LOCALITY(locality_id);
ALTER TABLE FLIGHT
